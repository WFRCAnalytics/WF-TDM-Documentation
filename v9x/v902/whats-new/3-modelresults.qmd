...
dfTransitSummary = pd.read_csv('data/intermediate/dfTransitSummary.csv')
dfRouteSummary = pd.read_csv('data/intermediate/dfRouteSummary.csv')
dfScenarios = pd.read_csv('data/intermediate/dfScenarios.csv')
dfTransitSummaryWithScenarioData = pd.read_csv('data/intermediate/dfTransitSummaryWithScenarioData.csv')
dfRouteSummaryWithScenarioData = pd.read_csv('data/intermediate/dfRouteSummaryWithScenarioData.csv')
dfTransitSummaryPlotData = pd.read_csv('data/intermediate/dfTransitSummaryPlotData.csv')
```
