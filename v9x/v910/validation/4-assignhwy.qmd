...
The maps in @fig-assign-compare-all through @fig-assign-compare-hv shows a comparison of segment level model vs observed volumes by vehicle types. Red represents model lower than observed and blue represents model volume higher than observed.
