...
The maps in @fig-assign-compare-all through @fig-assign-compare-hv shows a comparison of segment level model vs observed volumes by vehicle types. Blue represents model lower than observed and red represent model volume higher than observed.
...
![Segment-Level Model vs Observed Volume Comparison -- Cars and Light Trucks](_pictures/vol-diff-Car.png){#fig-assign-compare-cars}
:::
...
```{python}
_path = r"../../../_large_files/v902/5_FinalNetSkims/"
