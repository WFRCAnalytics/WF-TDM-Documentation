...
#| echo: False
import pandas as pd
mdist_age = pd.read_csv(r'data/1-hhdisagg-autoown/TAZ_AgePct_Lookup-2022-06-07_v9.0-2023-06-30.csv')
...
```{python}
gpi_age = pd.read_csv(r'data/1-hhdisagg-autoown/ControlTotal_SE-2022-08-31_v9.0-2023-06-30.csv')
...
```{python}
#| include: False
hhts = pd.read_csv(r'data/1-hhdisagg-autoown/2012_HHSurvey-HHData_2022-09-29.csv')[['record_ID','h_CO_FIPS_v30','h_CO_NAME_v30','weight','hhsize','life_cycle']]
hhts_lf_pop = hhts
...
lc_dbf = pd.DataFrame(DBF(r'data/1-hhdisagg-autoown/LifeCycle_Households_Population_v9.0-2023-06-30-BY_2019.dbf', load=True))
...
```{python}
import pandas as pd
hhsizevalid_csv = pd.read_csv('data/1-hhdisagg-autoown/HHSizeValidation.csv')
