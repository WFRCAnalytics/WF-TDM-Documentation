...
#| echo: False
import pandas as pd
mdist_age = pd.read_csv(r'data/1-lifecycle/TAZ_AgePct_Lookup-2022-06-07_v9.0-2023-06-30.csv')
...
::: {.content-visible when-format="html"}
```{python}
gpi_age = pd.read_csv(r'data/1-lifecycle/ControlTotal_SE-2022-08-31_v9.0-2023-06-30.csv')
...
lc_dbf = pd.DataFrame(DBF(r'data/1-lifecycle/LifeCycle_Households_Population_v9.0-2023-06-30-BY_2019.dbf', load=True))
