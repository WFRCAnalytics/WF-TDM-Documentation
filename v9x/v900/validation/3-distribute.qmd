...
The validation for the Trip Distribution are shown in this section. The model and observed data are compared for Generalized Cost, Distance, and Time. The model was validated using the following measures: 
