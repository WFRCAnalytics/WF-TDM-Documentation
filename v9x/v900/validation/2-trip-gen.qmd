...
hh_house_csv = pd.read_csv('data/1-lifecycle/2012_HHSurvey-HHData_2022-09-29.csv')
...
hh_trips_csv = pd.read_csv('e:/github/tdm-documentation/v9x/v900/validation/data/1-lifecycle/2012_HHSurvey-TripData_2022-11-21.csv')
...
mod_pa = pd.DataFrame(DBF(r'data/4-trip-gen/pa.dbf',load=True))
...
se_data = pd.DataFrame(DBF(r'data/4-trip-gen/SE_File_v9_SE19_Net19.dbf',load=True))
