...
The interactive @fig-mc-boardings allows for the visual comparison of model and observed values for each *Transit Trips and Boardings* category.
...
//|fig-cap: Transit Trips and Boardings Model vs Observed Comparison
tbEmptyCell = 1
```
...
The interactive  @fig-mode-share allows for selecting of different combinations to visualize the comparisons. The observed data comes from a combination of the Household Travel Survey and the 2019 Transit On-Board Survey.
...
## Boardings
@fig-pdf-boardings show validation charts to understand the transit boardings, linked trips, transfer ratios, and mode surveyed between modeled and observed. 
