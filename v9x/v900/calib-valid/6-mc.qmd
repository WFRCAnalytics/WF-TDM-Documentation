...
```{python}
df_OBS = pd.read_csv(r'data/6-mc/2019 Final Weighted UTA OD Data - 2020-09-09_BH.csv')
...
```{python}
df_HHS  = pd.read_csv(r'data\6-mc\TripData_June19_2013.csv')
...
```{python}
df_TDM_Pk  = pd.read_csv(r'data\6-mc\v9_SE19_Net19_RegionShares_Pk.csv')
df_TDM_Ok  = pd.read_csv(r'data\6-mc\v9_SE19_Net19_RegionShares_Ok.csv')
...
#dfC_Long.to_csv('data/6-mc/dfC_Long.csv')
#dataLong2 = FileAttachment("data\\6-mc\\dfC_Long.csv").csv({ typed: true });
#| echo: false
...
dbf_TDM_PARoute=pd.DataFrame(DBF(r"data/6-mc/_v9_SE19_Net19_1_PA_Route.dbf", load=True))
dbf_TDM_PARoute
