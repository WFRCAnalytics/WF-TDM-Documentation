...
**Figure 3: Transit boardings by absoluate and percent difference.**
...
viewof bViewSelect = Inputs.select(new Map([['Diff', 'Diff'], ['PercentDiff','PercentDiff']]), {value: 'View', label: "Display Value"})
```
