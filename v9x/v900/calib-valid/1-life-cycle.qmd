...
#| echo: False
import pandas as pd
mdist_age = pd.read_csv(r'data/1-lifecycle/MEDDIST-AgePct-WF-Lookup.csv')
...
::: {.content-visible when-format="html"}
```{python}
gpi_age = pd.read_csv(r'data/1-lifecycle/chk_Age_ControlTotal_SE_2022_08_31.csv')
...
::: {.content-hidden when-format="html"}
![GPI County Population Projections by Age Group for Wasatch Front Counties.](_pictures/1-plot2.png){#fig-pdf-gpi-age}
:::

<mark>???UPDATE TO USE 2023-06-09 version instead of 2023-04-28???</mark>
...
```{python}
#| include: False
hhts = pd.read_csv(r'data/1-lifecycle/2012_HHSurvey-HHData_2022-09-29.csv')[['record_ID','h_CO_FIPS_v30','h_CO_NAME_v30','weight','hhsize','life_cycle']]
hhts_lf_pop = hhts
...
lc_dbf = pd.DataFrame(DBF(r'data/1-lifecycle/LifeCycle_Households_Population_v9.0-2023-04-28-BY_2019.dbf', load=True))
