---
title: Household Disaggregation
echo: false
---
...
![2010 Census Block Group Data - Household Size Share by Average Household Size.](_pictures/2-excel1.png){#fig-hh-poly-curves}
...
```{python}
hhlf_csv = pd.read_csv(r'data/2-hhdisag/HHSize_byLC.csv').replace(r'^.*-.*$',0,regex=True)
```
...
![Comparison of Household Size Lookup Curves by County – Life Cycle 1.](_pictures/2-excel4.png){#fig-hhcounty-1}

![Comparison of Household Size Lookup Curves by County – Life Cycle 2.](_pictures/2-excel5.png){#fig-hhcounty-2}

![Comparison of Household Size Lookup Curves by County – Life Cycle 3.](_pictures/2-excel6.png){#fig-hhcounty-3}
...
::: {.content-visible when-format="html"}
```{python}
hhsizevalid_csv = pd.read_csv('data/2-hhdisag/HHSizeValidation.csv')
