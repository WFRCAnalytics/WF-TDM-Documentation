...
```{python}
import pandas as pd
gc_csv = pd.read_csv('data/5-distrib/v9-gencost-mod-obs.csv')
dist_csv = pd.read_csv('data/5-distrib/v9-dist-mod-obs.csv')
time_csv = pd.read_csv('data/5-distrib/v9-time-mod-obs.csv')
```
