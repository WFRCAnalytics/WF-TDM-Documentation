...
//|fig-cap: Household and Job Forecast Map)
//|echo: false
...
Updates to the highway node numbering schema are shown in @tbl-master-network-node-numbering-schema. An additional reference file called *\_Node Definition - v832 & v9.xlsx* is found in the highway folder.
...
This network file includes most recently updated MAG merged master network with updated 2032, 2042 & 2050 Needs fields. Snapped updated MAG network with ‘MasterNet - 2022-09-08.net’ that included WFRC’s latest changes.

<mark>???WHY IS 2022-09-08 MENTIONED BUT NOT LISTED BELOW???</mark>

#### 2022-09-19a

This network file includes the following changes:
...
Additionally, a 'MergedMasterNet - 2022-09-19a' folder was added to serve as a workspace for editing and updating Merged Master Network and for exporting to v832 & v9 Master Networks.
...
The following transit line files were renumbered according to new highway node numbering schema:
...
### CUBE Public Transport (PT) Parameters

The node numbers in the factor files were updated to correspond with the new highway network nodes.
...
With the change in model extents, a change in external locations was necessitated. Additionally, the forecasts were updated with additional years of observed data.

### Location

Updated to new External Node locations and numbering scheme:
