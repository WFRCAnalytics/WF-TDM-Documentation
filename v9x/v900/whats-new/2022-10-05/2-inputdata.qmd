...
The college base distribution source (_Source - CollegeBaseDistribution - 2022-08-30.xlsx) and model lookup (BaseDistribution.csv) files were updated to the v9.0.0 TAZ structure using the centroids of the v8.3.2 TAZ to identify the new v9.0.0 TAZ.
...
table = [["3"  , 'Box Elder', '1-153'    ],
		 ...
		 ["49" , 'Utah'     , '2217-3546']]
df = pd.DataFrame(table, columns = ["CO_FIPS","CO_NAME", "TAZ Range"])
Markdown(tabulate(
  table, 
