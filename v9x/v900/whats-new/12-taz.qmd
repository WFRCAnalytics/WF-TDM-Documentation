...
In addition, the following changes were made to the TAZ shapefile:
 ...
 - **PRKCSTPERM** and **PRKCSTTEMP** fields were updated (see [Parking Costs](https://wfrc.org/wftdm-docs/v9x/v900/whats-new/15-baseyear.html#parking-costs) for additional information)
...
The interactive map in @fig-taz-compare-map show the difference in TAZ boundaries between version 9 and version 8.
