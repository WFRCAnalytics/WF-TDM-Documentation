...
![Comparison of Wasatch Front Income Lookup Curves](_pictures/lookup-curves.png){#fig-lookup}
...
![Initial Wait Time Curve](_pictures/initial-wait-time.png){#fig-initial-wait-time}
