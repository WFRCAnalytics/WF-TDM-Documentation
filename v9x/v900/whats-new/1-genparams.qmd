...
display(table.style.hide_index().set_properties(subset=["v9Value", "v8Value"], **{'text-align': 'right'}).set_table_styles([dict(selector='th', props=[('text-align', 'center')])]))
```
...
table = table[['Parameter', 'v9Value', 'v8Value','Notes']]
display(table.style.hide_index().set_properties(subset=["v9Value", "v8Value"], **{'text-align': 'right'}))
```
