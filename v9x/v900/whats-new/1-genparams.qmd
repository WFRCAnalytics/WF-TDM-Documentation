...
headers = ['Parameter', 'v9Value', 'v8Value']
Markdown(tabulate(table, 
  headers=headers, 
  tablefmt="pipe", 
  colalign=("left",)*len(headers), 
...
headers = ['Area', 'v9Parameter','v9Value', 'v8Parameter','v8Value']
Markdown(tabulate(table, 
  headers=headers, 
  tablefmt="pipe", 
  colalign=("left",)*len(headers), 
...
headers = ['v9Parameter','v9Value', 'v8Parameter','v8Value','Notes']
Markdown(tabulate(table, 
  headers=headers, 
  tablefmt="pipe", 
  colalign=("left",)*len(headers), 
