...
headers = ['Parameter', 'v9Value', 'v8Value','Notes']
...
```{python}
#gdfpath1 = r"A:\1 - TDM\1 - Input Dev\5 - External\_GIS_Layers\Master Net\MasterNet - 2022-07-29_Link.shp"
#gdfpath2 = r"A:\1 - TDM\1 - Input Dev\5 - External\_GIS_Layers\Master Net\MasterNet - 2022-07-29_Node.shp"
#
#gdf1 = gpd.read_file(gdfpath1)
#gdf2 = gpd.read_file(gdfpath2)
#
#gdf1.to_file('data/intermediate/MasterNet - 2022-07-29_Link.shp')
#gdf2.to_file('data/intermediate/MasterNet - 2022-07-29_Node.shp')
```

```{python}
gdfintpath1 = r'data/intermediate/MasterNet - 2022-07-29_Link.shp'
gdfintpath2 = r'data/intermediate/MasterNet - 2022-07-29_Node.shp'
```
...
if not os.path.isfile('data/masternetlink.geojson'):
  gdfMasterNetLink = gpd.read_file(gdfintpath1)
...
if not os.path.isfile('data/masternetnode.geojson'):
  gdfMasterNetNode = gpd.read_file(gdfintpath2)
