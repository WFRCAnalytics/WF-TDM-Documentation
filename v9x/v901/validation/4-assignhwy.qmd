...
```{python}
allveh_valid = pd.read_csv("data/5-assignhwy/wf-validation-04-17-2024-AllVeh.csv")
...
![Segment-Level Model vs Observed Volume Comparison by Vehicle Type](_pictures/5-assignhwy-map-v901.jpg){#fig-map}
