...
hh_house_csv = pd.read_csv('data/1-hhdisag-autoown/2012_HHSurvey-HHData_2022-09-29.csv', low_memory=False)
...
hh_trips_csv = pd.read_csv('data/1-hhdisag-autoown/2012_HHSurvey-TripData_2022-11-21.csv', low_memory=False)
...
se_data = pd.DataFrame(DBF(r'data/2-tripgen/SE_File_v901_SE19_Net19.dbf',load=True))
